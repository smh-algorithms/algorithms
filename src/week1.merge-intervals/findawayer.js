// Runtime: 84 ms, faster than 95.23% of JavaScript online submissions for Merge Intervals.
// Memory Usage: 41 MB, less than 42.93% of JavaScript online submissions for Merge Intervals.
function solution(intervals) {
  ...
  for (let i = 1; i < length; i += 1) {
    ...
    if (top[0] <= current[0] && current[0] <= top[1]) {
